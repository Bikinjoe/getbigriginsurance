...
export const faqs: FAQItem[] = [
  {
    slug: "cost-new-authority",
    question: "How much does trucking insurance cost for a new authority?",
    answer: `For a new authority owner operator, expect to pay between $8,000 and $18,000 per year for primary liability and physical damage combined. That's the realistic range for most new authorities running dry van, flatbed, or reefer freight.
...
We can quote all of this in a single pass. Call or text 541-681-8793.`,
  },
  {
    ...
    question: "Can I get same-day trucking insurance coverage?",
    answer: `Yes, same-day coverage is possible for most new authorities and owner operators if you come in prepared. We bind same-day policies almost every business day.
...
The fastest way to lower your rate long term is to stay clean. Every ticket, every accident, every out-of-service event stays on your record and follows you carrier to carrier.`,
  },
  {
    ...
    question: "What is primary liability insurance for trucking?",
    answer: `Primary liability insurance pays for bodily injury and property damage you cause to others while operating your truck in commerce. It's the single most important policy you carry and the only one federally required before you can activate your authority.
...
The carrier files your primary liability with FMCSA as a BMC-91 or BMC-91X. That filing is what activates your authority.`,
  },
  {
    ...
    question: "Do I need cargo insurance as an owner operator?",
    answer: `Yes, in practical terms. While FMCSA does not require cargo insurance for most general freight carriers, every freight broker and most direct shippers require it before they'll give you a load. The standard minimum is $100,000 in cargo coverage.
...
We write both. If you call us and we think you're not ready to run your own authority, we'll tell you.`,
  ...
  {
    slug: "best-rate",
    question: "How do I get the best rate on trucking insurance?",
    answer: `The best rate comes from a combination of things: clean driving history, an appropriate commodity and radius match, working with a specialist who shops multiple carriers, and a realistic approach to coverage.
...
Don't chase the cheapest quote. The cheapest quote is usually the most dangerous, it's often missing coverage you need or will be repriced by the carrier after underwriting. Best rate and cheapest rate are not the same thing.`,
  },
  {
    ...
    question: "What carriers insure new trucking authorities?",
    answer: `Many carriers write new authorities, but not the household names you'd assume. Some of the largest nationally known insurance companies don't write trucking at all, or they won't write new authorities. Others specialize in exactly this niche.
...
Add-ons to consider: downtime coverage (pays while your truck is in the shop after a covered loss), rental reimbursement, towing coverage. Each adds a small amount but can save a lot if you actually use them.`,
  ...
  {
    slug: "occ-acc",
    question: "Do I need occupational accident insurance?",
    answer: `Probably yes if you're leased onto a motor carrier. Maybe not if you run your own authority and operate as a sole proprietor.
...
Don't skip this if you're leased on. Getting hurt on the job without coverage is financially catastrophic. A month off the road without income is enough to lose the truck.`,
  ...
  {
    slug: "broker-requirements",
    question: "What does a broker require for insurance before giving me loads?",
    answer: `Most freight brokers have a standard insurance requirement sheet that lists the minimum coverages they need to see on your certificate of insurance before they'll dispatch you loads. The specifics vary slightly, but the core requirements are consistent across the industry.
...
If you're starting to work with a new broker, ask for their insurance requirement sheet in writing. We'll set up your COI exactly to their spec.`,
  ...
  {
    slug: "violations-on-record",
    question: "Can I get trucking insurance with violations on my record?",
    answer: `Yes, in most cases. Tickets and accidents on your record don't automatically disqualify you from coverage, but they do raise your rate and narrow the pool of carriers willing to quote you.
...
- Producer (your agent) name and contact info
- Insured (your business) name, DOT number, MC number
- Each insurance carrier and policy number
- Coverage types: liability, cargo, physical damage, general liability, etc.
- Limits and deductibles
- Effective and expiration dates
- Certificate holder (the broker or shipper) name and address
- Additional insured designations if required
- Any specific endorsements the broker needs
...
As your agent, we advocate for you throughout the claim process. If the adjuster is slow, we push. If a claim is being improperly denied, we escalate. Call us first even if you're not sure if it's a claim, we'll tell you whether to file.`,
  ...
  {
    slug: "lapse",
    question: "What happens if I let my trucking insurance lapse?",
    answer: `A lapse in trucking insurance is one of the most expensive mistakes an owner operator can make. It has immediate legal, operational, and long-term financial consequences.
...
- Flatbed of standard building materials
- Box truck freight
- Paper products, packaging

Medium-risk commodities:
- Reefer general grocery
- Auto parts
- Retail goods
- Agricultural equipment

Higher-risk commodities:
- Auto transport (multi-car haulers, operator trailers)
- Household goods
- High-value freight (electronics, pharmaceuticals)
- Tanker operations
- Livestock

Highest-risk commodities:
- Hazmat (class dependent)
- Oversize/overweight
- Explosives
...
Be truthful about what you haul. Some policies will deny claims if the commodity hauled wasn't disclosed during underwriting. If you told your agent you haul dry van and then took a hazmat load, you may have a coverage problem.`,
  },
  {
    ...
    answer: `The FMCSA minimum insurance requirement depends on what you haul. For the majority of general freight carriers, the minimum is $750,000 in primary liability coverage.

Here are the exact federal minimums:

General freight (most common): $750,000 combined single limit primary liability
Hazardous substances (Class 8, non-bulk hazmat, etc.): $1,000,000
Oil moved by motor carrier: $1,000,000
Bulk hazardous materials (certain classes): $5,000,000
...
The takeaway: the FMCSA minimum keeps you legal, but it's not enough to run a business. Carry $1M primary liability minimum, and add cargo, physical damage, and the other coverages discussed on this site.`,
  ...
  {
    slug: "750k-vs-1m",
    question: "Should I get $750K or $1M liability coverage?",
    answer: `Get $1M. Every time. For a new authority or any owner operator planning to haul brokered freight, the $750K minimum just isn't practical.
...
- While you're operating the truck without a load and not under dispatch
- Includes driving home, running errands, taking the truck to personal service

What NTL does not cover:
- Damage to your own truck (that's physical damage)
- Cargo (there is no cargo during bobtail use)
- Injuries to yourself (that's occupational accident or personal health coverage)
- Use during dispatched loads (that's the motor carrier's primary)
...
If you're leased on and your motor carrier requires NTL or bobtail on your paperwork, that's what they're asking for. Either term is correct. Same coverage, different names.`,
  ...
  {
    slug: "finding-agent",
    question: "How do I find a good independent trucking insurance agent?",
    answer: `Finding a good independent trucking insurance agent is mostly about identifying specialists who actually understand trucking and have the carrier relationships to back it up. Generic insurance agents who dabble in trucking will not get you the best rate or the right coverage.
...
- No trucking-specific content on their website
- Hard to reach by phone
- Want to charge a flat broker fee
- Push one specific carrier without explanation
- Promise rates that are far below market without showing you the policy

If you want, call us and ask us any of these questions. We'll answer honestly.`,
  },
  {
    slug: "info-for-quote",
    question: "What information do I need to get a trucking insurance quote?",
    answer: `To get an accurate trucking insurance quote, you need to provide specific information about your business, your truck, your drivers, and your operation. The more you have ready up front, the faster we can turn around real quotes.

Business information:
- Legal business name
- DBA if applicable
- DOT number (if issued)
- MC number (if issued)
- Business address
- Years in operation
- Business structure (sole prop, LLC, corp)
- Federal EIN (for LLCs and corps)

Truck information:
- Year, make, model
- VIN (17 characters)
- GVWR (gross vehicle weight rating)
- Current value or financed balance
- Lienholder if financed (loss payee name and address)
- Radius of operation (local, regional, all 48)
...
- Prior employer and DOT number (if recently employed)
- Any accidents, tickets, or violations in the last 3-5 years

Operation information:
- Commodities hauled (be specific)
- Percentage breakdown if multiple commodities
- Anticipated annual miles
- Typical broker/shipper relationships
...
- Expiration date
- Any prior claims (dates, description, amount paid)

Coverage preferences:
- Liability limit ($1M standard)
- Cargo limit ($100K standard)
- Physical damage deductible ($1K-$5K typical)
- Additional coverages (trailer interchange, non-owned trailer, reefer breakdown, etc.)
